export const MODBUS_ADDRESSES = {
  ...
  SOFTWARE_PLC_INPUT_START: parseInt(process.env.NEXT_PUBLIC_READ_START_3 || '1410', 10),
  SOFTWARE_PLC_OUTPUT_START: parseInt(process.env.NEXT_PUBLIC_READ_START_4 || '1414', 10),
};
